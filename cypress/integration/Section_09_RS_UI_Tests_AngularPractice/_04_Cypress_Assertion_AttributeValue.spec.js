...
describe('Section_09_RS_UI_Tests_AngularPractice - Test Suite - Rahul Shetty Automation Practice - _04_Cypress_Assertion_AttributeValue',function(){
  ...
  beforeEach(() => {
    ...
    it('Test case for Assertion AttributeValue',function(){
