...
//Testing Framework - Mocha
    ...
    describe('TAGGING_TITLE_@smoke, Section_05_RS_UI_Tests_GreenKart - Test Suite - Rahul Shetty Green Kart - _06_Cypress_ParentChild',function(){
    //describe('Section_05_RS_UI_Tests_GreenKart - Test Suite - Rahul Shetty Green Kart - _06_Cypress_ParentChild',function(){

        it('Test case for _06_Cypress_ParentChild',{tags:['regression','smoke']},function(){
    ...
    it('Test case for _03_Cypress_Type - Intentionally Failing',{tags:['regression']},function(){
